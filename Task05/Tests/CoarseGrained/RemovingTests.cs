...
namespace Tests.CoarseGrained
{
    ...
    {
        [TestCase(0)]
        public void Remove_RootInCoarseTree_ReturnEmptyTree(int value)
        {
        ...
        [TestCase(0)]
        public void Remove_NonExistentNodeInCoarseTree_ReturnEmptyTree(int value)
        {
            var tree = new CoarseGrainedSyncBinaryTree<int>();
            tree.Insert(value);
        ...
        [TestCase(5, 3, 1)]
        public void Remove_RootInCoarseTree_SetNewRootFromLeft(int rootValue, int leftValue, int leftOfLeftValue)
        {
            var tree = new CoarseGrainedSyncBinaryTree<int>();
        ...
        [TestCase(5, 7, 9)]
        public void Remove_RootInCoarseTree_SetNewRootFromRight(int rootValue, int rightValue, int rightOfRightValue)
        {
            var tree = new CoarseGrainedSyncBinaryTree<int>();
            tree.Insert(rootValue);
        ...
        [TestCase(5, 2, 4, 3)]
        public void Remove_RootInCoarseTree_UpdateRootFromLeftNeighbor(int rootValue, int leftValue, 
        ...
        [TestCase(5, 8, 6, 7)]
        public void Remove_RootInCoarseTree_UpdateRootFromRightNeighbor(int rootValue, int rightValue, 
        ...
        [TestCase(5, 8, 7, 6)]
        public void Remove_InnerNodeInCoarseTree_UpdateFromRight(int rootValue, int rightValue, 
        ...
        [TestCase(5, 1, 3, 4)]
        public void Remove_InnerNodeInCoarseTree_UpdateFromLeft(int rootValue, int leftValue, 
        ...
        [TestCase(1, 2)]
        public void Remove_RightLeafInCoarseTree_UpdateTree(int rootValue, int rightValue)
        {
            var tree = new CoarseGrainedSyncBinaryTree<int>();
            tree.Insert(rootValue);
            tree.Insert(rightValue);
        ...
        [TestCase(2, 1)]
        public void Remove_LeftLeafInCoarseTree_UpdateTree(int rootValue, int leftValue)
        {
            var tree = new CoarseGrainedSyncBinaryTree<int>();
            tree.Insert(rootValue);
            tree.Insert(leftValue);
