...
namespace Tests.CoarseGrained
{
    ...
    public class ParallelScenarios
    {
        ...
        public void InsertFindConcurrently_ManyValuesToCoarseTree_UpdateTree(int workers, int maxSize, 
            int maxValue, int maxTimeout)
        {
            var expectedTree = new CoarseGrainedSyncBinaryTree<int>();
            var actualTree = new CoarseGrainedSyncBinaryTree<int>();
        ...
        [TestCase(30, 1000, 1000, 10)]
        public void InsertSequentially_RemoveFindConcurrently_ManyValuesToCoarseTree_UpdateTree(int workers, 
        ...
        public void InsertRemoveFindConcurrently_ManyValuesToCoarseTree_UpdateTree(int workers, 
            int maxSize, int maxValue, int maxTimeout)
        {
            var actualTree = new CoarseGrainedSyncBinaryTree<int>();
            var elementsToInsert = new ConcurrentQueue<int>();
        ...
        public void InsertSequentially_InsertFindConcurrently_ManyValuesToCoarseTree_UpdateTree(int workers, 
            int maxSize, int maxValue, int maxTimeout)
        {
            var actualTree = new CoarseGrainedSyncBinaryTree<int>();
