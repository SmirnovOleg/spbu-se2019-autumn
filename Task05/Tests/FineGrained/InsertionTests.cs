...
namespace Tests.FineGrained
{
    ...
    public class InsertionTests
    {
        ...
        [TestCase(5, 3, 1)]
        public void Insert_InOrderLeftLeftToFineTree_UpdateTree(int rootValue, int leftValue, int leftOfLeftValue)
        {
            var tree = new FineGrainedSyncBinaryTree<int>();
        ...
        [TestCase(5, 3, 4)]
        public void Insert_InOrderLeftRightToFineTree_UpdateTree(int rootValue, int leftValue, int rightOfLeftValue)
        {
            var tree = new FineGrainedSyncBinaryTree<int>();
        ...
        [TestCase(5, 7, 9)]
        public void Insert_InOrderRightRightToFineTree_UpdateTree(int rootValue, int rightValue, int rightOfRightValue)
        {
            var tree = new FineGrainedSyncBinaryTree<int>();
